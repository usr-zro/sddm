    ...
    MouseArea {
        ...
        QQC2.StackView {
            ...
            initialItem: Login {
                ...
                actionItems: [
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/Fluent/assets/suspend_primary.svgz"
                        text: i18ndc("plasma-desktop-sddm-theme", "Suspend to RAM", "Sleep")
                        onClicked: sddm.suspend()
                        enabled: sddm.canSuspend
                    },
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/Fluent/assets/restart_primary.svgz"
                        text: i18nd("plasma-desktop-sddm-theme", "Restart")
                        onClicked: sddm.reboot()
                        enabled: sddm.canReboot
                    },
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/Fluent/assets/shutdown_primary.svgz"
                        text: i18nd("plasma-desktop-sddm-theme", "Shut Down")
                        onClicked: sddm.powerOff()
                        enabled: sddm.canPowerOff
                    },
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/Fluent/assets/switch_primary.svgz"
